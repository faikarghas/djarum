...
@section('main')
    <main page="about">
        <section class="section__first">
            ...
            <div class="right-1">
                <h5>Kretek consists of three main ingredients: tobacco, natural cloves and spices with fruit sauce. All these elements, grown in the unique climate of Indonesia, give each Djarum cigarette a unique taste.</h5>
